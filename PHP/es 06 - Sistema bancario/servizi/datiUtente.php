<?php
    ...
    $sql = "SELECT * FROM movimenti,conti,operazioni WHERE conti.cConto = movimenti.cConto and movimenti.cOperazione = operazioni.cOperazione and conti.cCorrentista = '$cCorrentista'";//dopo where CONDIZIONE DI JOIN, il campo in comune alle due tabelle
    $rs = _execute($con, $sql);
    if($rs){
